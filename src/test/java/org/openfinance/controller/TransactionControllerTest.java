...
class TransactionControllerTest {
    ...
    @Test
    @DisplayName(
            "GET /api/v1/transactions/{id}/splits - should return 404 for non-existent transaction")
    ...
    @Test
    @DisplayName(
            "GET /api/v1/transactions/{id}/splits - should return 401 when encryption session missing")
    ...
    @Test
    @DisplayName(
            "GET /api/v1/transactions/{id}/splits - should return 401 when encryption session empty")
