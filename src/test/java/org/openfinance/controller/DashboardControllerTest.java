...
/**
 * Integration tests for DashboardController focusing on Asset Allocation and Portfolio Performance
 * endpoints.
 *
 * <p>Tests cover: - GET /api/v1/dashboard/asset-allocation - GET
 * /api/v1/dashboard/portfolio-performance - Authentication and authorization - Various data
...
class DashboardControllerTest {
            ...
            mockMvc.perform(
                    ...
                    .andExpect(
                            jsonPath(
                                    "$[*].type",
                                    containsInAnyOrder(
                                            "STOCK", "ETF", "CRYPTO", "BOND", "REAL_ESTATE")));
        }
    }
    ...
    /**
     * Creates an asset using the API endpoint to ensure proper encryption handling. This method
    ...
    /**
     * Creates a net worth snapshot for historical data testing. Direct repository save is
