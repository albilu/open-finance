...
class RecurringTransactionServiceTest {
    ...
    class CreateRecurringTransactionTests {
        ...
        void shouldCreateRecurringTransaction() {
            ...
            RecurringTransactionResponse response =
                    recurringTransactionService.createRecurringTransaction(1L, testRequest);
        ...
        void shouldCreateTransferRecurringTransaction() {
            ...
            // When
            RecurringTransactionResponse response =
                    recurringTransactionService.createRecurringTransaction(1L, transferRequest);
        ...
        void shouldCreateRecurringTransactionWithLongDescription() {
            ...
            // When
            RecurringTransactionResponse response =
                    recurringTransactionService.createRecurringTransaction(1L, longDescRequest);
    ...
    class UpdateRecurringTransactionTests {
        ...
        void shouldUpdateRecurringTransaction() {
            ...
            // When
            RecurringTransactionResponse response =
                    recurringTransactionService.updateRecurringTransaction(1L, 1L, updateRequest);
    ...
    class GetRecurringTransactionTests {
        ...
        void shouldGetRecurringTransactionById() {
            ...
            // When
            RecurringTransactionResponse response =
                    recurringTransactionService.getRecurringTransactionById(1L, 1L);
        ...
        void shouldThrowNotFoundExceptionWhenGettingNonExistent() {
            ...
            // When/Then
            assertThatThrownBy(
                            () -> recurringTransactionService.getRecurringTransactionById(999L, 1L))
                    .isInstanceOf(RecurringTransactionNotFoundException.class);
        ...
        void shouldGetAllRecurringTransactions() {
            ...
            List<RecurringTransactionResponse> responses =
                    recurringTransactionService.getAllRecurringTransactions(1L);
        ...
        void shouldGetActiveRecurringTransactions() {
            ...
            // When
            List<RecurringTransactionResponse> responses =
                    recurringTransactionService.getActiveRecurringTransactions(1L);
        ...
        void shouldGetDueRecurringTransactions() {
            ...
            // When
            List<RecurringTransactionResponse> responses =
                    recurringTransactionService.getDueRecurringTransactions(1L);
    ...
    class PauseResumeTests {
        ...
        void shouldPauseRecurringTransaction() {
            ...
            // When
            RecurringTransactionResponse response =
                    recurringTransactionService.pauseRecurringTransaction(1L, 1L);
