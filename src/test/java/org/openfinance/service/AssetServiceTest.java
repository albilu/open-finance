 ...
 *
 * <p>Tests CRUD operations, validation, authorization, and portfolio analytics calculations.
 */
...
class AssetServiceTest {
    ...
    void shouldThrowExceptionWhenAccountNotFound() {
        ...
        // Act & Assert
        assertThrows(AccountNotFoundException.class, () -> assetService.createAsset(1L, request));
    ...
    void shouldValidateNullParametersOnCreate() {
        ...
        assertThrows(IllegalArgumentException.class, () -> assetService.createAsset(null, request));
        assertThrows(IllegalArgumentException.class, () -> assetService.createAsset(1L, null));
    }
    ...
    void shouldThrowExceptionWhenUpdatingNonExistentAsset() {
        ...
        // Act & Assert
        assertThrows(
                AssetNotFoundException.class, () -> assetService.updateAsset(99L, 1L, request));
        verify(assetRepository, never()).save(any());
    }
    ...
    void shouldValidateNullParametersOnUpdate() {
        ...
        assertThrows(
                IllegalArgumentException.class, () -> assetService.updateAsset(null, 1L, request));
        assertThrows(
                IllegalArgumentException.class, () -> assetService.updateAsset(1L, null, request));
        assertThrows(IllegalArgumentException.class, () -> assetService.updateAsset(1L, 1L, null));
    }
    ...
    void shouldThrowExceptionWhenDeletingNonExistentAsset() {
        ...
        // Act & Assert
        assertThrows(AssetNotFoundException.class, () -> assetService.deleteAsset(99L, 1L));
    ...
    void shouldValidateNullParametersOnDelete() {
        assertThrows(IllegalArgumentException.class, () -> assetService.deleteAsset(null, 1L));
        assertThrows(IllegalArgumentException.class, () -> assetService.deleteAsset(1L, null));
    }
    ...
    @Test
    @DisplayName(
            "Should get asset plaintext fields without encryption key when encryption is disabled")
    ...
    void shouldThrowExceptionWhenGettingNonExistentAsset() {
        ...
        // Act & Assert
        assertThrows(AssetNotFoundException.class, () -> assetService.getAssetById(99L, 1L));
    }

    @Test
    @DisplayName("Should validate null parameters on getAssetById")
    void shouldValidateNullParametersOnGetById() {
        assertThrows(IllegalArgumentException.class, () -> assetService.getAssetById(null, 1L));
        assertThrows(IllegalArgumentException.class, () -> assetService.getAssetById(1L, null));
    }
    ...
    void shouldLeaveSecondaryFieldsNullWhenNoSecondaryCurrencyConfigured() {
        ...
        User user =
                User.builder().baseCurrency("EUR").build(); // secondaryCurrency is null by default
