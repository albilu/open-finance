...
class TransactionSplitServiceTest {
    ...
    void shouldSaveSplitsSuccessfully() {
        ...
        // Act
        transactionSplitService.saveSplits(transactionId, splits);
    ...
    void shouldClearSplitsWhenNullProvided() {
        ...
        // Act
        transactionSplitService.saveSplits(transactionId, null);
    ...
    void shouldClearSplitsWhenEmptyListProvided() {
        ...
        // Act
        transactionSplitService.saveSplits(transactionId, List.of());
    ...
    void shouldReturnDecryptedSplitsWithCategoryDenormalization() {
        ...
        List<TransactionSplit> splits =
                List.of(
                        createSplitEntity(1L, transactionId, 1L, new BigDecimal("40.00"), "desc1"),
                        createSplitEntity(2L, transactionId, 2L, new BigDecimal("60.00"), "desc2"));
    ...
    void shouldHandleDecryptionFailureGracefully() {
        ...
        List<TransactionSplit> splits =
                List.of(
                        createSplitEntity(
                                1L, transactionId, 1L, new BigDecimal("100.00"), "some-desc"));
        ...
        // Assert — JPA converter handles decryption transparently, so
        // description is returned as-is from the entity
        assertThat(responses).hasSize(1);
        assertThat(responses.get(0).getDescription()).isEqualTo("some-desc");
    }
