-- Migration V61: Add RECURRING_TRANSACTION to attachment entity type constraint
-- Extends the attachments table to support recurring-transaction file attachments.
--
-- SQLite does not support ALTER CONSTRAINT, so we recreate the table with
-- the updated CHECK constraint and a wider entity_type column (VARCHAR 25).
