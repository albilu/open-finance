...
public class SecurityConfig {
    ...
    /**
     * Creates the encryption key filter bean, registered exclusively in the security filter chain
     * (not auto-registered as a servlet filter via {@code @Component}) to avoid double-firing.
     */
    @Bean
