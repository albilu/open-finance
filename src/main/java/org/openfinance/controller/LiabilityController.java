...
public class LiabilityController {
    ...
    public ResponseEntity<LiabilityResponse> createLiability(
            @Valid @RequestBody LiabilityRequest request, Authentication authentication) {
        ...
        LiabilityResponse response = liabilityService.createLiability(user.getId(), request);
    ...
    public ResponseEntity<List<LiabilityResponse>> getLiabilities(
        ...
        if (type != null) {
            liabilities = liabilityService.getLiabilitiesByType(user.getId(), type);
        } else {
            liabilities = liabilityService.getLiabilitiesByUserId(user.getId());
        }
    ...
    public ResponseEntity<LiabilityResponse> getLiability(
        ...
        User user = (User) authentication.getPrincipal();
        LiabilityResponse liability = liabilityService.getLiabilityById(liabilityId, user.getId());
    ...
    public ResponseEntity<LiabilityResponse> updateLiability(
        ...
        LiabilityResponse response =
                liabilityService.updateLiability(liabilityId, user.getId(), request);
    ...
    public ResponseEntity<Void> deleteLiability(
        ...
        User user = (User) authentication.getPrincipal();
        liabilityService.deleteLiability(liabilityId, user.getId());
    ...
    public ResponseEntity<List<AmortizationScheduleEntry>> getAmortizationSchedule(
        ...
        List<AmortizationScheduleEntry> schedule =
                liabilityService.calculateAmortizationSchedule(liabilityId, user.getId());
    ...
    public ResponseEntity<Map<String, BigDecimal>> getTotalInterest(
        ...
        BigDecimal totalInterest =
                liabilityService.calculateTotalInterest(liabilityId, user.getId());
    ...
    public ResponseEntity<LiabilityBreakdownResponse> getLiabilityBreakdown(
        ...
        LiabilityBreakdownResponse breakdown =
                liabilityService.getLiabilityBreakdown(liabilityId, user.getId());
    ...
    public ResponseEntity<List<TransactionResponse>> getLinkedTransactions(
        ...
        List<TransactionResponse> transactions =
                liabilityService.getLinkedTransactions(liabilityId, user.getId());
    ...
    public ResponseEntity<Map<String, BigDecimal>> getTotalLiabilities(
        ...
        Map<String, BigDecimal> totalsByCurrency =
                liabilityService.calculateTotalLiabilities(user.getId());
