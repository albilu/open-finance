...
public class TransactionController {
    ...
    public ResponseEntity<TransactionResponse> createTransfer(
        ...
        User user = (User) authentication.getPrincipal();
        TransactionResponse response = transactionService.createTransfer(user.getId(), request);
    ...
    public ResponseEntity<TransactionResponse> updateTransfer(
        ...
        TransactionResponse response =
                transactionService.updateTransfer(transferId, user.getId(), request);
    ...
    public ResponseEntity<TransactionResponse> getTransactionById(
            @PathVariable("id") Long transactionId, Authentication authentication) {

        log.info("Retrieving transaction: id={}", transactionId);
        User user = (User) authentication.getPrincipal();
        TransactionResponse response =
                transactionService.getTransactionById(transactionId, user.getId());
    ...
    public ResponseEntity<List<TransactionResponse>> getTransactions(
        ...
        if (accountId != null) {
            ...
            transactions = transactionService.getTransactionsByAccount(user.getId(), accountId);
            ...
            transactions =
                    transactionService.getTransactionsByDateRange(user.getId(), dateFrom, dateTo);
        } else {
    ...
    public ResponseEntity<TransactionResponse> updateTransaction(
        ...
        User user = (User) authentication.getPrincipal();
        TransactionResponse response =
                transactionService.updateTransaction(transactionId, user.getId(), request);
    ...
    public ResponseEntity<Page<TransactionResponse>> searchTransactions(
        ...
        Page<TransactionResponse> results =
                transactionService.searchTransactions(user.getId(), criteria, pageable);
    ...
    public ResponseEntity<List<TransactionResponse>> getTransactionsByTag(
            @PathVariable String tag, Authentication authentication) {
        User user = (User) authentication.getPrincipal();
        log.info("Fetching transactions with tag '{}' for user id={}", tag, user.getId());

        List<TransactionResponse> transactions =
                transactionService.getTransactionsByTag(user.getId(), tag);
    ...
    public ResponseEntity<List<TransactionSplitResponse>> getSplitsForTransaction(
        ...
        List<TransactionSplitResponse> splits =
                transactionService.getSplitsForTransaction(transactionId, user.getId());
