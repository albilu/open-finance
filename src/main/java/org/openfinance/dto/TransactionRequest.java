...
public class TransactionRequest {
    ...
    /** Optional ID of a liability tranche this transaction is associated with. */
    private Long trancheId;

    /** Optional ID of a real estate property this transaction is associated with. */
    private Long realEstateId;

    /** Optional ID of an asset this transaction is associated with. */
