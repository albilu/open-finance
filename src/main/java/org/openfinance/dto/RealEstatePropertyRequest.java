...
public class RealEstatePropertyRequest {
    ...
    @DecimalMin(value = "0.00", message = "{realestate.current.value.min}")
    @Digits(integer = 26, fraction = 18, message = "{realestate.purchase.price.digits}")
    ...
    @DecimalMin(value = "0.00", message = "{realestate.current.value.min}")
    @Digits(integer = 26, fraction = 18, message = "{realestate.current.value.digits}")
    ...
    @com.fasterxml.jackson.annotation.JsonIgnore private boolean mortgageIdPresent;

    public void setMortgageId(Long value) {
        this.mortgageId = value;
        this.mortgageIdPresent = true;
    }
    ...
    @jakarta.validation.constraints.AssertTrue(message = "{realestate.acquisition.price}")
    public boolean isAcquisitionPriceValid() {
        return purchasePrice == null
                || purchasePrice.signum() > 0
                || acquisitionType == org.openfinance.entity.AcquisitionType.GIFT
                || acquisitionType == org.openfinance.entity.AcquisitionType.PLANNED;
    }

    @jakarta.validation.constraints.AssertTrue(message = "{realestate.purchase.date.future}")
    ...
    @jakarta.validation.constraints.AssertTrue(message = "{realestate.planned.value}")
