...
public class Transaction {
    ...
    /**
     * Optional link to a liability tranche this transaction is associated with.
     *
     * <p>When set, this transaction (typically a DISBURSEMENT or REPAYMENT movement) is linked to a
     * specific tranche of a loan disbursed in stages.
     */
    @Column(name = "tranche_id")
    private Long trancheId;

    /** Optional link to a real estate property this transaction is associated with. */
    @Column(name = "real_estate_id")
    private Long realEstateId;

    /** Optional link to an asset this transaction is associated with. */
