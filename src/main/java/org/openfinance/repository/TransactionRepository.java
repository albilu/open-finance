...
public interface TransactionRepository
    ...
    /**
     * Finds all active transactions for a specific account (source account only).
     *
     * <p>Used for balance recalculation in Java when amount is encrypted.
     *
     * @param accountId the source account ID
     * @return list of active transactions for the account
     */
